...
class disaster_model extends CI_Model{
		...
		public function get_evacuation_stats($id){
																				...
																				FROM
																					(
																						...
																						FROM
																							...
																							-- 	(
																							-- 		SELECT DISTINCT
																							-- 			ON (t4.brgy_located_ec) t4.provinceid, t4.municipality_id,
																							-- 			CONCAT ('0', t4.brgy_located_ec) brgy
																							-- 		FROM
																							-- 			tbl_evacuation_stats t4
																							-- 		LEFT JOIN tbl_disaster_title t5 ON t4.disaster_title_id = t5. ID
																							-- 		WHERE
																							-- 			t4.disaster_title_id = $id -- disaster_title_id
																							-- 		GROUP BY
																							-- 			t4.municipality_id,
			...
			$query_all_munis = $this->db->query("SELECT 
												...
												LEFT JOIN public.lib_municipality t2 ON t1.municipality_id = t2. ID)t1
												GROUP BY t1.iscity
								");
		...
		public function get_map($id){
			...
			// 																				t1.disaster_title_id = $id
			// 																			AND (
			// 																				t1.provinceid = 160200000
			// 																				OR t1.provinceid = 160300000
			// 																				OR t1.provinceid = 166700000
			// 																				OR t1.provinceid = 166800000
			// 																				OR t1.provinceid = 168500000
			// 																			)
			// 																			GROUP BY
			// 																				t1.municipality_id
			// 																		) t1
			...
			// 																				t2.disaster_title_id = $id
			// 																			AND (
			// 																				t2.provinceid = 160200000
			// 																				OR t2.provinceid = 160300000
			// 																				OR t2.provinceid = 166700000
			// 																				OR t2.provinceid = 166800000
			// 																				OR t2.provinceid = 168500000
			// 																			)
			// 																			GROUP BY
			// 																				t2.municipality_id
			// 																		)
		...
		public function activatewebuser($users,$isadminpriv,$iscancreatepriv){
