      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="dashboard_graph">
            ...
            <div class="col-md-2 col-sm-12 col-xs-12" data-step="9" data-intro="This part shows the list of all the created reports of disaster incidents in a year.">
            ...
            <div class="col-md-4 col-sm-12 col-xs-12" data-step="5" data-intro="This part shows the latest weather update issued by PAGASA!">
            ...
            <div class="col-md-5 col-sm-12 col-xs-12" data-step="6" data-intro="This part shows the latest radar image forecast issued by PAGASA!">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" data-step="8" data-intro="This part shows the Hazard Visualization for weather monitoring!" data-position='left'>
