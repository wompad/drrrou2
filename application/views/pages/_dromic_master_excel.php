...
<div class="row" style="background-color: #fff">
	<ul class="nav nav-tabs">
	  ...
	  <li><a data-toggle="tab" href="#home2" class="btn btn-sm btn-danger tabpill" style="border-radius:0px; border-radius: 5px 5px 0px 0px; padding: 5px; font-size: 15px; background-color: #7AB900" id="toexcel2">Form 1.2 (Damages and Assistance - F2)</a></li>
	  <li class="dropdown">
	  		<a class="dropdown-toggle btn btn-sm btn-danger tabpill" data-toggle="dropdown" href="#" style="border-radius:0px; border-radius: 5px 5px 0px 0px; padding: 5px; font-size: 15px; background-color: #006400">  Status of Displacement <b class="caret"></b></a>
	  		<ul class="dropdown-menu">
	            	 <li ><a data-toggle="tab" href="#evacuation_stats" id="toexcel3" style="font-size: 15px">Form 2 - (EC Evacuations - F3)</a></li>
	            	 <li ><a data-toggle="tab" href="#evacuation_stats_outside" id="toexcel4" style="font-size: 15px">Form 3 (Outside EC Evacuations - F4)</a></li>
				     <li><a data-toggle="tab" style="font-size: 15px">EC Sex Disaggregated Data </a></li>
				     <li><a data-toggle="tab" style="font-size: 15px"> EC Facilities </a></li>
	        </ul>
	  </li>
	  ...
	  <!-- <li><a data-toggle="tab" href="#casualties" class="btn btn-md btn-danger tabpill" style="border-radius:0px; border-radius: 5px; padding: 5px; font-size: 15px" id="toexcel5">Form 4 (Casualties - F5)</a></li> -->
	  <!-- <li><a data-toggle="tab" href="#sex_disaggregations" class="btn btn-sm btn-danger tabpill" style="border-radius:0px; color:#fff; border-radius: 5px; padding: 5px; font-size: 11px" id="toexcel8">Form 5 (EC Sex Disaggregation - F3)</a></li> -->
	  <li><a data-toggle="tab" href="#damagesperbrgy" class="btn btn-md btn-danger tabpill" style="border-radius:0px; border-radius: 5px 5px 0px 0px; padding: 5px; font-size: 15px; background-color: #7AB900" id="toexcel7">Damages and Assistance per Barangay - F7</a></li>
	  ...
	  <li class="dropdown">
	  		...
	  		<ul class="dropdown-menu">
	            <?php if($_SESSION['can_create_report'] == 't'){ ?> <li ><a id="addnarrativebtn" style="font-size: 15px"> <span class="fa fa-file-word-o"></span> Attach Narrative Report</a></li> <?php } ?>
				     ...
				     <li><a id="addCommentsbtn" data-toggle="tab" href="#disastermap" style="font-size: 15px"> <i class="fa fa-sticky-note"></i> Discussions <span class="badge badge-primary" id="commentcounter"></span></a></li>
	        </ul>
	  </li>
	...
	<div class="tab-content">
		...
		<div class="form-group col-md-12" style="margin-left: -10px">
			<div class="btn-group" style="border-radius: 5px">
			  	<button style="border-radius: 5px; margin-right: 5px; font-size: 15px; border-radius: 5px 5px 0px 0px" type="button" class="btn btn-success btn-sm" id="saveasnewrecord"><i class="fa fa-plus-circle"></i> Save as new Record and Update Data (Ctrl+S)</button>
			  	<div class="btn-group" style="margin-right: 5px" id="addfamiecs">
				   <button style="border-radius: 5px; font-size: 15px; background-color: #006400; border-radius: 5px 5px 0px 0px" type="button" class="btn btn-sm btn-primary dropdown-toggle tabpill" data-toggle="dropdown">
				   ...
				   <ul class="dropdown-menu" role="menu" style="margin-top:7px">
				     ...
				     <li style="background-color: #1BA160; font-size: 15px; color: #fff !important;"><a id="addfamiec" style="color: #000"> Add Affected Families Inside EC (Ctrl+I)  </a></li>
				     <!-- <li style="background-color: #FBBC05;"><a id="addfamiecprofile" style="color: #000"> Add Sex Disaggregation to EC Data  </a></li>
				     <li style="background-color: #277DB8;"><a id="addfamiecprofile" onclick="msgbox('Currently under development :-)')" style="color: #000"> Add Facilities to EC Data  </a></li> -->
				     <li style="background-color: #1BA160; font-size: 15px;"><a id="addfamoec" style="color: #000"> Add Affected Families Outside EC (Ctrl+Q) </a></li>
				     
				     <!-- <li><a id="printbtn"> <span class="fa fa-print"></span> Print (Ctrl+P) </a></li> -->
				   </ul>
				</div>
				<button style="border-radius: 5px 5px 0px  0px; margin-right: 5px; font-size: 15px; background-color: #EA8825" type="button" class="btn btn-warning btn-sm" id="adddamass"><i class="fa fa-plus-circle"></i> Add Cost of Assistance [P/MLGU] (Ctrl+D)</button>
				<!-- <button style="border-radius: 5px; margin-right: 5px; font-size: 15px" type="button" class="btn btn-danger btn-sm" id="addcasualtybtn"><i class="fa fa-plus-circle"></i> Add Casualties (Ctrl+X)</button> -->
				<button style="border-radius: 5px 5px 0px 0px; margin-right: 5px; font-size: 15px" type="button" class="btn btn-default btn-sm" id="exporttoexcel"><label style="border-radius: 5px; border:1px solid #006400; position:absolute; width:30px; height:40px; margin-top:-9px; margin-left:-3px; background-color:#006400; color:#fff;"><i class="fa fa-file-excel-o" style="margin-top:11px; margin-left:3px; cursor:pointer"></i></label>          Export to Excel (Ctrl+E)
				</button>
				<!-- <button style="border-radius: 5px; margin-right: 5px; font-size: 15px" type="button" class="btn btn-primary btn-sm" id="addCommentsbtn"> </button> -->
				<!-- <div class="btn-group">
				   ...
				   <ul class="dropdown-menu" role="menu"> -->
				     ...
				     <!-- <li><a id="addCommentsbtn" style="font-size: 15px"> <span class="fa fa-sticky-note"></span> Discussions <span class="badge badge-primary" id="commentcounter"></span> </a></li> -->
				     <!-- <li><a id="printbtn"> <span class="fa fa-print"></span> Print (Ctrl+P) </a></li> -->
				   <!-- </ul>
				</div> -->
			</div>
...
<!-- 		<div class="form-group col-md-12" style="margin-left: -10px">
	    	...
	    	<div class="col-md-12" style="padding: 0px; width: 2000px" id="tbl_masterquery_revs">
		    	<table style="width:100%; font-size: 11px" id="tbl_masterquery_revss" class="tbl_masterquery_revs">
		    		<thead>
		    			...
		    			<tr>
		    				<td rowspan="5" style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #D9E2F3; color: #000; padding: 2px; font-weight: bold">REGION/<br>PROVINCE/MUNICIPALITY</td>
		    				<td colspan="5" rowspan="3" style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">NUMBER OF AFFECTED</td>
		    			...
		    			<tr>
		    				<td colspan="2" style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">BRGYS. </td>
		    				<td rowspan="2" style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">FAMILIES </td>
		    				<td rowspan="2" style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">PERSONS </td>
		    				<td rowspan="2" style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">4Ps FAMILIES </td>
		    			...
		    			<tr>
		    				<td style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">NAME</td>
		    				<td style="vertical-align: middle; text-align:center; border:1px solid #000; background-color: #C5E0B3; color: #000; padding: 2px; font-weight: bold">COUNT</td>
	  ...
	  <div id="evacuation_stats" class="tab-pane fade">
	  	<div class="col-md-12" style="margin-top:10px"><label><i class="fa fa-info-circle"></i> Reminders: Right click each entry to update/edit.</label></div>
            ...
            <div class="modal-body">
              ...
              <div class="row">
              	...
              	<div class="form-group col-md-6" id="eccum">
              		...
              		<input type="number" class="form-control" id="ecicum" min="0" max="1">
              	</div>
              	<div class="form-group col-md-6" id="ecnow">
              		<label> <i style="color:red">*</i>  EC NOW </label>
              		<input type="number" class="form-control" id="ecinow" min="0" max="1">
              	</div>
              	<div class="form-group col-md-6">
...
<!-- 	            <div class="row">
              ...
              <div class="row">
              	...
              	<!-- <div class="form-group col-md-6" style="border-right: 3px solid gray; border-bottom: 3px solid gray">
              		<center><label class="red"> INFANT >1 y/o (0-11mos) </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="infant_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="infant_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="infant_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="infant_female_now">
	              	</div>
              	</div> -->
              	<!-- <div class="form-group col-md-6" style="border-bottom: 3px solid gray">
              		<center><label class="red"> TODDLERS 1-3 y/o </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="toddler_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="toddler_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="toddler_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="toddler_female_now">
	              	</div>
              	</div> -->
              	<!-- <div class="form-group col-md-6" style="border-right: 3px solid gray; border-bottom: 3px solid gray">
              		<center><label class="red"> PRESCHOOLERS 4-5 y/o </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="preschooler_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="preschooler_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="preschooler_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="preschooler_female_now">
	              	</div>
              	</div> -->
              	<!-- <div class="form-group col-md-6" style="border-bottom: 3px solid gray">
              		<center><label class="red"> SCHOOL AGE 6-12 y/o </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="schoolage_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="schoolage_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="schoolage_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="schoolage_female_now">
	              	</div>
              	</div> -->
              	<div class="form-group col-md-6" style="border-right: 3px solid gray; border-bottom: 3px solid gray">
              		<center><label class="red"> TEENAGE 13-19 y/o </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="teenage_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="teenage_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="teenage_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="teenage_female_now">
	              	</div>
              	</div>
              	<div class="form-group col-md-6" style="border-bottom: 3px solid gray">
              		<center><label class="red"> ADULT 20-59 y/o </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="adult_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="adult_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="adult_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="adult_female_now">
	              	</div>
              	</div>
              	<div class="form-group col-md-12" style="border-bottom: 3px solid gray">
              		<center><label class="red"> SENIOR CITIZEN 60 and above </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="senior_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="senior_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="senior_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="senior_female_now">
	              	</div>
              	</div>
              </div>
              <div class="row">
              	<div class="form-group col-md-3" style="border-bottom: 3px solid gray;">
              		<center><label class="red"> PREGNANT </label></center>
              		<div class="form-group col-md-6">
	              		<center><label class="green"> CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="pregnant_cum">
	              	</div>
	              	<div class="form-group col-md-6">
	              		<center><label class="green"> NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="pregnant_now">
	              	</div>
              	</div>
              	<div class="form-group col-md-3" style="border-right: 3px solid gray; border-bottom: 3px solid gray;">
              		<center><label class="red"> LACTATING MOTHER </label></center>
              		<div class="form-group col-md-6">
	              		<center><label class="green"> CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="lactating_cum">
	              	</div>
	              	<div class="form-group col-md-6">
	              		<center><label class="green"> NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="lactating_now">
	              	</div>
              	</div>
              	<div class="form-group col-md-3" style="border-bottom: 3px solid gray;">
              		<center><label class="red"> SOLO PARENTS </label></center>
              		<div class="form-group col-md-6">
	              		<center><label class="green"> CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="solo_cum">
	              	</div>
	              	<div class="form-group col-md-6">
	              		<center><label class="green"> NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="solo_now">
	              	</div>
              	</div>
              	<div class="form-group col-md-3" style="border-bottom: 3px solid gray;">
              		<center><label class="red"> IPs </label></center>
              		<div class="form-group col-md-6">
	              		<center><label class="green"> CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="ip_cum">
	              	</div>
	              	<div class="form-group col-md-6">
	              		<center><label class="green"> NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="ip_now">
	              	</div>
              	</div>
              	<div class="form-group col-md-12">
              		<center><label class="red"> PERSONS WITH DISABILITY </label></center>
              		<div class="form-group col-md-3">
	              		<center><label class="green"> MALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="disable_male_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> MALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="disable_male_now">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE CUM </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="disable_female_cum">
	              	</div>
	              	<div class="form-group col-md-3">
	              		<center><label class="green"> FEMALE NOW </label></center>
	              		<input style="text-align:center" type="number" class="form-control" id="disable_female_now">
	              	</div>
              	</div>
            </div>
            <div class="modal-footer">
    ...
    <div id='cntnr'>
		<ul id='items'>
		  <li id="openModalEC" style="border-bottom: 1px solid #A6A6A6; padding: 3px; background-color: #006400; color: #fff" class="rightclickmenu">Update Evacuation Center Data</li>
